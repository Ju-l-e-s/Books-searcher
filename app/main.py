...
async def analyze_shelf(image: UploadFile = File(...)):
    ...
    try:
        ...
        # 2. Resolve ISBNs in parallel (weighted scoring + DynamoDB cache)
        ...
        # 3. Fetch prices in parallel via httpx (4 s timeout, DynamoDB cache)
        ...
        # 4. Deduplicate and sort by best price
